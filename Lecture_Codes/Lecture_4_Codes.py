...
"""
rohan = {24, 24, 6.5, "Naks", "Data Engineer", "O & M"}
print(rohan)
print(type(rohan))
naks = set() # Empty set
"""
...
rohan = {24, 24, 6.5, "Naks", "Data Engineer", "O & M"}
print(rohan)
rohan.add("ApeX") # Inserts the value given in set.
print(rohan)
rohan.remove("ApeX")  # Removes given value from set
print(rohan)
rohan.pop() # Removes any random element from set
print(rohan)
rohan.clear() # Empty out the set.
print(rohan)

naks = {22, "Nepto", 5, "Software engineer", 24}
print(rohan.union(naks)) # Combines both set values and returns new
print(rohan.intersection(naks)) # Combines common values and returns new
"""
